			...
			<div class="col-lg-9">
				<nav class="toolbox _bdbtw-1 _bdcl-border _mgbt-30">
					<div class="toolbox-left">
						<h1 class="_fs-30 _cl-font-2 _fw-400">สินค้าทั้งหมด</h1>
					...
					<div class="widget topic">
						<ul class="_lst-n _cl-font-3">
							...
							foreach ($allTopics as $item)
								<li class="_fs-18 _fw-300 _pdh-16 _pdv-10">
									<a class="_cl-font-3 _cl-gold-2-hover" href="{{route('topic', ['topic' => $item->slug])}}">{{$item->name}}</a>
								</li>
							endforeach
