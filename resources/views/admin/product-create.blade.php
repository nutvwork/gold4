	...
	<form v-cloak class="m-form" id="product" @submit.prevent="create">
			...
			<div class="row">
				<div class="col-lg-8">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-8">
							<input type="file" ref="cover" class="form-control m-form__control" accept="image/*" id="customFile" required>
				...
				<div class="col-lg-4">
					<img class="img-fluid" id="view" style="max-height: 250px;">
		...
		<div class="row">
			<div class="col-lg-4">
				...
				<button type="reset" @click="reset" class="btn btn-secondary ml-4">ยกเลิก</button>
			</div>
		</div>
	</form>
@endsection
	...
	new Vue({
		...
		methods: {
			...
			create() {
				...
				$form.append('product_photo', JSON.stringify(this.listPhoto))
				this.fetchPost('/admin/product/create', $form).then((res) => {
